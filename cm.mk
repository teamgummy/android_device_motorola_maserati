...
PRODUCT_BUILD_PROP_OVERRIDES += \
   ...
   BUILD_FINGERPRINT=${PRODUCT_BRAND}/${PRODUCT_DEVICE}_${PRODUCT_SFX}/${TARGET_DEVICE}:${ANDROID_VERSION}/${MOTOROLA_BUILD_ID}/${BUILD_NUMBER}:${TARGET_BUILD_TYPE}/${BUILD_VERSION_TAGS} \
   PRIVATE_BUILD_DESC=${TARGET_DEVICE}"-"${TARGET_BUILD_TYPE}" "${ANDROID_VERSION}" "${MOTOROLA_BUILD_ID}" "${BUILD_NUMBER}" "${BUILD_VERSION_TAGS} \
